                    ...
                    <div className="form-section form-header">
                        <div className="row justify-content-center"> 
                            <div className="col-7 mg-top-30 text-center">
                                <img src="/images/TITLE _ PATIENCE.png" className="img-fluid" alt="Header" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="form-section form-content-body">
                        <div className="row">
                            <div className="col-11 mg-top-20 dotation-image-container">
                                <img src="/images/Text_patience.png" className="img-fluid dotation-img" alt="Texte formulaire" />
                            </div>
                        </div>
                    </div>
