    ...
    <div className="col-md-8 col-xl-5 col-12 main_view pd-bottom-120">
      ...
      <div className="row justify-content-center">
        <div className="col-11 mg-top-20 text-center">
          <img src="/images/ctig/hello/txt_already.png" className="img-fluid" alt="Une participation" />
        </div>
      </div>

      <div className="row justify-content-center">
        <div className="col-10 mg-top-20 text-center">
          <p>Vous avez déjà participé à ce jeu. Une seule participation est autorisée.</p>
        </div>
      </div>
